    ...
    return (
        <footer className="footer--container">
            <div className="footer--link--container">
                <div>
                    <img src={image} alt="Logoipsum" className="footer--img" />
                </div>
                ...
                <div className="footer--social--icon">
                    <ul>
                        <li>
                            <a
                                href="https://www.facebook.com/erion.haxhikadrija.33/"
                        ...
                        <li>
                            <a
                                href="https://www.linkedin.com/in/erion-haxhikadrija-a1b313279/"
                                className="navbar--content"
                                target="_blank"
                                rel="noreferrer"
                            >
            ...
            <div className="footer--content--container">
                <p className="footer--content">haxhikadrija.erion@gmail.com</p>
                <div className="footer--social--icon">
                    <ul>
                        <li>
                            <Link
